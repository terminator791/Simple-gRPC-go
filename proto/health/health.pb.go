...
const file_proto_health_health_proto_rawDesc = "" +
	...
	"\aservice\x18\x01 \x01(\tR\aservice\"\xc3\x01\n" +
	"\x13HealthCheckResponse\x12A\n" +
	"\x06status\x18\x01 \x01(\x0e2).health.HealthCheckResponse.ServingStatusR\x06status\x12\x18\n" +
	...
	"\x05Watch\x12\x1a.health.HealthCheckRequest\x1a\x1b.health.HealthCheckResponse0\x01B4Z2github.com/terminator791/Simple-gRPC-go/pkg/healthb\x06proto3"
